...
ax1.plot([0,1],[0.233,0.233],linewidth=0.5,color="black")
ax1.plot([0,0],[0.233,0.234],linewidth=0.5,color="black")
ax1.plot([1,1],[0.233,0.234],linewidth=0.5,color="black")
ax1.text(0.45, 0.231, "***", fontsize=12)

ax1.plot([0,2],[0.273,0.273],linewidth=0.5,color="black")
ax1.plot([0,0],[0.273,0.272],linewidth=0.5,color="black")
ax1.plot([2,2],[0.273,0.272],linewidth=0.5,color="black")
ax1.text(1, 0.2735, "o", fontsize=12)

ax1.plot([2,3],[0.233,0.233],linewidth=0.5,color="black")
ax1.plot([2,2],[0.233,0.234],linewidth=0.5,color="black")
ax1.plot([3,3],[0.233,0.234],linewidth=0.5,color="black")
ax1.text(2.45, 0.231, "***", fontsize=12)

# ------

ax2.plot([0,1],[0.305,0.305],linewidth=0.5,color="black")
ax2.plot([0,0],[0.305,0.306],linewidth=0.5,color="black")
ax2.plot([1,1],[0.305,0.306],linewidth=0.5,color="black")
ax2.text(0.45, 0.3026, "***", fontsize=12)

ax2.plot([0,2],[0.352,0.352],linewidth=0.5,color="black")
ax2.plot([0,0],[0.352,0.351],linewidth=0.5,color="black")
ax2.plot([2,2],[0.352,0.351],linewidth=0.5,color="black")
ax2.text(1, 0.3525, "o", fontsize=12)

ax2.plot([2,3],[0.305,0.305],linewidth=0.5,color="black")
ax2.plot([2,2],[0.305,0.306],linewidth=0.5,color="black")
ax2.plot([3,3],[0.305,0.306],linewidth=0.5,color="black")
ax2.text(2.45, 0.3026, "***", fontsize=12)
